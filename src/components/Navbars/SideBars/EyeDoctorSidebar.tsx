...
export default function EyeDoctorSidebar() {
  ...
  return (
    <section>
      <List>
        ...
        {[
          { text: "Dashboard", path: "/clinical/eye", icon: LayoutPanelLeft },
          { text: "Patients", path: "/clinical/eye/patients", icon: ContactRound },
        ].map((item) => {
