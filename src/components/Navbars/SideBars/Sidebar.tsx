  ...
  return (
    <Box component="nav" className='nav'>
      ...
      <Box
          ...
          className="drawer-container px-4 pt-[3.8rem] pb-[0.6rem] md:pt-[5.5rem] lg:py-3 flex flex-col gap-2 overflow-auto scrollbar-hide h-full"
        >
          {/* Header */}
          <List className='bg-transparent'>
            <div className="flex items-center gap-3">
              <div className="w-[44px] h-[44px] rounded-full bg-red-500 overflow-hidden flex items-center justify-center">
                <img
              ...
              <div className="flex flex-col text-start">
                <span className="text-xs text-gray-500 uppercase">{roleLabel} PORTAL</span>
                <h2 className="text-sm font-semibold text-white">DHML-MRS</h2>
              </div>
            </div>
          </List>

          <div className="w-full h-[1px] bg-gray-500 my-1 lg:my-2" />
          {/* Sidebar Links */}
      ...
      {!isMobile && !isTablet && (
        ...
        >
          <Box
            onClick={handleDrawerToggle}
            sx={{ textAlign: "center", backgroundColor: "transparent" }}
            className="drawer-container px-4 pt-[4rem] md:pt-[9rem] lg:py-3 flex flex-col gap-2 overflow-auto scrollbar-hide h-full"
          >
            {/* Header */}
            <List>
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col text-start">
                  <span className="text-xs text-gray-500 uppercase">{roleLabel} PORTAL</span>
                  <h2 className="text-sm font-semibold text-white/70">NAFRC-MRS</h2>
                </div>
              </div>
            </List>
