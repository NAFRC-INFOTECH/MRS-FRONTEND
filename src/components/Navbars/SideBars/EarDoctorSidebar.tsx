...
export default function EarDoctorSidebar() {
  ...
  return (
    <section>
      <List>
        <span className="block text-start text-xs text-gray-500 pl-4 mb-2">MAIN</span>
        {[
          { text: "Dashboard", path: "/clinical/ear", icon: LayoutPanelLeft },
          { text: "Patients", path: "/clinical/ear/patients", icon: ContactRound },
        ].map((item) => {
