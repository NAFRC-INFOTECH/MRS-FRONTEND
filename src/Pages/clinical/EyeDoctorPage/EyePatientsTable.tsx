...
export default function EyePatientsTable() {
  ...
  const { data: daylist = [], isLoading } = useClinicalDayListQuery("EyeDoctor", "all", "GOPD");
  ...
  return (
    <div className="p-4">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-xl font-semibold">Eye Checkups (Transferred from GOPD)</h2>
      </div>
                ...
                <tr key={r.id} className="even:bg-[#f9f9f9] border-b border-gray-200">
                  ...
                  <td className="px-4 py-2 whitespace-nowrap">
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent>
                        <DropdownMenuItem
                          onClick={() => navigate(`/clinical/eye/patient-history/${r.id}`)}
