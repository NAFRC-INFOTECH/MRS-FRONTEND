...
export const createDutyApi = async (payload: { role: "doctor" | "staff" | "recording" | "radiology"; staffId: string; departmentId: string; date: string; shift: DutyShift; timeIn: string; timeOut: string; status: DutyStatus; assignedBy: string }): Promise<DutyRecord> => {
